...
export class WidgetService {
  ...
  constructor() {
    ...
    this.viewsPath = join(__dirname, '..', '..', 'views', 'widgets');
  }
   ...
   */
  getSamplePizzaCarousel(): WidgetData {
    const places = [
      {
        id: 'nova-slice-lab',
        name: 'Nova Slice Lab',
   ...
   */
  getSamplePizzaListByTopping(topping: string): WidgetData {
   ...
   */
  getSamplePizzaAlbums(): WidgetData {
    const albums = [
      {
        id: 'summer-escape',
        title: 'Summer Slice',
